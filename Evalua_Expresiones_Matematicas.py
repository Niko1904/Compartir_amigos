...
def apilar(pcar, ppila, ppostfijo):
    ...
    prioridad_infija = {"**": 4, "^": 4, "*": 2, "/": 2,  "%": 2, "+": 1, "-": 1, "(": 5, ")": "NA"}
    prioridad_pila = {"**": 3, "^": 3, "*": 2, "/": 2,  "%": 2, "+": 1, "-": 1, "(": 0, ")": "NA"}
...
#expinfija = "3*4/(3+1)"
#expinfija = "4(5+6-8)"
#expinfija = "(6 + 2) * 3/2 ^ 2 - 4"
#expinfija = "2 * 300 + (4500 + 50000) 10"
#expinfija = "24 * (150 + 6000 - (81/20**3)-789) - 100 (5+1) "

""" Calcula el 10% de la expresion (ver arriba) y se la suma el porcentaje (10%) """
expinfija = "(24 * (150 + 6000 - (81/20**3)-789) - 100 (5+1)) + (24 * (150 + 6000 - (81/20**3)-789) - 100 (5+1)) % 10"

infija = basico(expinfija.replace(' ', '')) # Eliminar espacios
print("Infija :", infija)
# ----------------------------------------
